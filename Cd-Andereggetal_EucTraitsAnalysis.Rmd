...
ACACsite <- lme(WD~Diameter + pPETscaled , random = ~ 1 | Plottag/Treetag, data = traits.b[which(traits.b$WD>0),], subset=Species=="ACAC")
ACACsite1 <- lme(WD~Diameter + pPETscaled , random = ~ 1 | Plottag/Treetag, data = traits.b[which(traits.b$WD>0),], subset=Species=="ACAC", weights = varIdent (form = ~1|Sitetag))
ACACsite2 <- lme(WD~Diameter + pPETscaled , random = ~ 1 | Plottag/Treetag, data = traits.b[which(traits.b$WD>0),], subset=Species=="ACAC", weights = varPower (form = ~ pPETscaled))
ACACsite3 <- lme(WD~Diameter + pPETscaled , random = ~ 1 | Plottag/Treetag, data = traits.b[which(traits.b$WD>0),], subset=Species=="ACAC", weights = varConstPower (form = ~pPETscaled))
...
anova(ACACsite, ACACsite1) #  change in var with plot p=0.00299
...
AIC(ESALsite, ESALsite1, ESALsite2, ESALsite3)
anova(ESALsite, ESALsite1, ESALsite2, ESALsite3) # no differences
...
anova(COCAsite, COCAsite2) # marginally significant, p=0.067, classify as 'none'
...
anova(VIMIsite, VIMIsite2) # no change needed!
```
...
anova(OBLIsite, OBLIsite2, OBLIsite3) # significant differences
...
scatter.smooth(abs(resid(ACACldmc$MD))~round(ACACldmc$MD@frame$pMDscaled,digits = 3))
...
residplots(model=COCAldmc$fert,climvar=bestvar, dataz=traits.b[which(traits.b$Species=="COCA" & traits.b$LDMC>0),]
           ,res.type = "pearson",mixed = T
           , Species = "COCA", Trait="LDMC", write.jpeg = F)
...
COCAsite4 <- lme(as.formula (paste("LDMC~ p",bestvar, sep="")) , random = ~ 1 | Plottag/Treetag, data = traits.b[which(traits.b$LDMC>0),], subset=Species=="COCA", weights = varConstPower (form = as.formula(paste("~",bestvar, "+5", sep=""))))
AIC(COCAsite, COCAsite1, COCAsite2, COCAsite3,COCAsite4)
anova(COCAsite, COCAsite1) # strong differences
anova(COCAsite, COCAsite2) #significant
# differ by site, but not apparently with climate or soil
...
residplots(model=OVATldmc$fert,climvar=bestvar, dataz=traits.b[which(traits.b$Species=="OVAT" & traits.b$LDMC>0),]
           ,res.type = "pearson",mixed = T
           , Species = "OVAT", Trait="LDMC", write.jpeg = F)
...
residplots(model=OBLIldmc$MD,climvar=bestvar, dataz=traits.b[which(traits.b$Species=="OBLI" & traits.b$LDMC>0),]
           ,res.type = "pearson",mixed = T
           , Species = "OBLI", Trait="LDMC", write.jpeg = F)
...
residplots(model=ESALlma$PET,climvar=bestvar, dataz=traits.b[which(traits.b$Species=="ESAL" & traits.b$LMA>0),]
           ,res.type = "pearson",mixed = T
           , Species = "ESAL", Trait="LMA", write.jpeg = F)
...
residplots(model=EMARGlma$PPT,climvar=bestvar, dataz=traits.b[which(traits.b$Species=="EMARG" & traits.b$LMA>0),]
           ,res.type = "pearson",mixed = T
           , Species = "EMARGnew", Trait="LMA", write.jpeg = T)
...
residplots(model=COCAlma$fert,climvar=bestvar, dataz=traits.b[which(traits.b$Species=="COCA" & traits.b$LMA>0),]
           ,res.type = "pearson",mixed = T
           , Species = "COCAnew", Trait="LMA", write.jpeg = F)
...
AIC(COCAsite, COCAsite1, COCAsite2, COCAsite3,COCAsite4)
anova(COCAsite, COCAsite2,COCAsite4)  # no diffs with climate
...
AIC(COCAsite, COCAsite1, COCAsite2, COCAsite3,COCAsite4)
anova(COCAsite, COCAsite2,COCAsite4) # no diffs with soil
...
residplots(model=OVATlma$PPT,climvar=bestvar, dataz=traits.b[which(traits.b$Species=="OVAT" & traits.b$LMA>0),]
           ,res.type = "pearson",mixed = T
           , Species = "OVAT", Trait="LMA",write.jpeg = F)
bestvar <- "PC1fert" # no climate relationship
residplots(model=OVATlma$PPT,climvar=bestvar, dataz=traits.b[which(traits.b$Species=="OVAT" & traits.b$LMA>0),]
           ,res.type = "pearson",mixed = T
           , Species = "OVAT", Trait="LMA",write.jpeg = F)
...
OVATsite2 <- lme(as.formula (paste("LMA~ p",bestvar,"scaled", sep="")) , random = ~ 1 | Plottag/Treetag, data = traits.b[which(traits.b$LMA>0),], subset=Species=="OVAT", weights = varPower (form = as.formula(paste("~ p",bestvar,"scaled + 1", sep=""))))
...
OVATsite4 <- lme(as.formula (paste("LMA~ p",bestvar,"scaled", sep="")) , random = ~ 1 | Plottag/Treetag, data = traits.b[which(traits.b$LMA>0),], subset=Species=="OVAT", weights = varConstPower (form = as.formula(paste("~ p",bestvar,"scaled + 1", sep=""))))

OVATsite5 <- lme(as.formula (paste("LMA~ p",bestvar,"scaled", sep="")) , random = ~ 1 | Plottag/Treetag, data = traits.b[which(traits.b$LMA>0),], subset=Species=="OVAT", weights = varPower (form = as.formula(paste("~ p",bestvar," + 1", sep=""))))
OVATsite6 <- lme(as.formula (paste("LMA~ p",bestvar,"scaled", sep="")) , random = ~ 1 | Plottag/Treetag, data = traits.b[which(traits.b$LMA>0),], subset=Species=="OVAT", weights = varPower (form = as.formula(paste("~ I(p",bestvar,"-400)", sep=""))))

AIC(OVATsite, OVATsite1, OVATsite2, OVATsite3,OVATsite4, OVATsite5, OVATsite6)
...
AIC(OVATsite, OVATsite1, OVATsite2, OVATsite3,OVATsite4, OVATsite5)
...
bestvar <- "pMD" 
residplots(model=VIMIlma$MD,climvar=bestvar, dataz=traits.b[which(traits.b$Species=="VIMI" & traits.b$LMA>0),]
           ,res.type = "pearson",mixed = T
           , Species = "VIMInew2", Trait="LMA", write.jpeg = F)
...
residplots(model=AMYGlma$PPT,climvar=bestvar, dataz=traits.b[which(traits.b$Species=="AMYG" & traits.b$LMA>0),]
           ,res.type = "pearson",mixed = T
           , Species = "AMYGnew", Trait="LMA", write.jpeg = F)
...
bestvar <- "pPET"
residplots(model=OBLIlma$PET,climvar=bestvar, dataz=traits.b[which(traits.b$Species=="OBLI" & traits.b$LMA>0),]
           ,res.type = "pearson",mixed = T
           , Species = "OBLI", Trait="LMA")

bestvar <- "PET"
OBLIsite <- lme(as.formula (paste("LMA~ p",bestvar,"scaled", sep="")) , random = ~ 1 | Plottag/Treetag, data = traits.b[which(traits.b$LMA>0),], subset=Species=="OBLI")
OBLIsite1 <- lme(as.formula (paste("LMA~ p",bestvar,"scaled", sep="")) , random = ~ 1 | Plottag/Treetag, data = traits.b[which(traits.b$LMA>0),], subset=Species=="OBLI", weights = varIdent (form = ~1|Sitetag))
OBLIsite2 <- lme(as.formula (paste("LMA~ p",bestvar,"scaled", sep="")) , random = ~ 1 | Plottag/Treetag, data = traits.b[which(traits.b$LMA>0),], subset=Species=="OBLI", weights = varPower (form = as.formula(paste("~ p",bestvar,"scaled", sep=""))))
OBLIsite3 <- lme(as.formula (paste("LMA~ p",bestvar,"scaled", sep="")) , random = ~ 1 | Plottag/Treetag, data = traits.b[which(traits.b$LMA>0),], subset=Species=="OBLI", weights = varPower (form = as.formula(paste("~ I(p",bestvar,"scaled + 5)", sep=""))))
OBLIsite4 <- lme(as.formula (paste("LMA~ p",bestvar,"scaled", sep="")) , random = ~ 1 | Plottag/Treetag, data = traits.b[which(traits.b$LMA>0),], subset=Species=="OBLI", weights = varConstPower (form = as.formula(paste("~ p",bestvar,"scaled", sep=""))))
AIC(OBLIsite, OBLIsite1, OBLIsite2, OBLIsite3)#,OBLIsite4)
...
residplots(model=ACAChub$MD,climvar=bestvar, dataz=traits.b[which(traits.b$Species=="ACAC" & traits.b$hub>0),]
           ,res.type = "pearson",mixed = T
           , Species = "ACAC", Trait="loghub", write.jpeg = T)
...
AIC(ESALsite, ESALsite1, ESALsite2, ESALsite3,ESALsite4)
anova(ESALsite, ESALsite1) # no evidence for changing variance
...
anova(EMARGsite, EMARGsite3) # decreasing with increasing PET
```
...
residplots(model=COCAhub$depth,climvar=bestvar, dataz=traits.b[which(traits.b$Species=="COCA" & traits.b$hub>0),]
           ,res.type = "pearson",mixed = T
           , Species = "COCA", Trait="loghub", write.jpeg = F)
bestvar <- "pPPT" # 
residplots(model=COCAhub$depth,climvar=bestvar, dataz=traits.b[which(traits.b$Species=="COCA" & traits.b$hub>0),]
           ,res.type = "pearson",mixed = T
           , Species = "COCA2", Trait="loghub", write.jpeg = F)
...
residplots(model=OVAThub$PPT,climvar=bestvar, dataz=traits.b[which(traits.b$Species=="OVAT" & traits.b$hub>0),]
           ,res.type = "pearson",mixed = T
           , Species = "OVAT", Trait="loghub", write.jpeg = F)
...
residplots(model=VIMIhub$fert,climvar=bestvar, dataz=traits.b[which(traits.b$Species=="VIMI" & traits.b$hub>0),]
           ,res.type = "pearson",mixed = T
           , Species = "VIMI", Trait="loghub", write.jpeg = F)
...
anova(VIMIsite, VIMIsite2) # no evidnece with soil
...
residplots(model=AMYGhub$PPT,climvar=bestvar, dataz=traits.b[which(traits.b$Species=="AMYG" & traits.b$hub>0),]
           ,res.type = "pearson",mixed = T
           , Species = "AMYG", Trait="loghub", write.jpeg = F)
...
residplots(model=OBLIhub$depth,climvar=bestvar, dataz=traits.b[which(traits.b$Species=="OBLI" & traits.b$hub>0),]
           ,res.type = "pearson",mixed = T
           , Species = "OBLI2", Trait="loghub", write.jpeg = F)
...
``` {r FIG 6}
###### FIG6: variances as f(clim) ############

### load summary stats for residual patterns:
respats <- read.csv("data/Resid_Patterns_20200209.csv") 
# these were manually summarized from Trait-Env modeling section
...
climvar<- "PPT"
model <-  lmer(LDMC~get(paste0("p",climvar,"scaled")) +  (1|Plottag) + (1|Treetag), data = traits.b, subset=Species=="OVAT"& pPPT>0, REML=F)

dataz <- traits.b[which(traits.b$Species=="OVAT" & traits.b$pPPT>0 & traits.b$LDMC>0),]
  ref.group <- ranef(model)
  ref.var.group1 <- tapply(residuals(model, type="pearson", level=1),
                           dataz[,names(ref.group[1])], var)
  ref.var.group2 <- tapply(residuals(model, type="pearson", level=1),
...
plot(sqrt(ref.group[[1]]$var)~ref.group[[1]][,paste0("p",climvar)], ylab="SD of LDMC (g/cm2)", col="grey", xlab=paste(climvar,"(mm)"))#"Moisture Deficit (mm)")
points(sqrt(ref.group[[2]]$var)~ref.group[[2]][,paste0("p",climvar)], pch=16, cex=1.5)

# plot(sdLDMC~pPPT, traits.t[which(traits.t$Species=="OVAT"),], ylab="SD of LDMC (g/cm2)", col="grey", xlab="Mean annual PPT (mm)")
# points(sdLDMC~pPPT, traits.p[which(traits.p$Species=="OVAT"),], pch=16, cex=1.5)
# summary(lm(sdLDMC~pPPT, traits.p[which(traits.p$Species=="OVAT"),]))

abline(lm(sqrt(ref.group[[2]]$var)~ref.group[[2]][,paste0("p",climvar)]), lwd=2)
abline(lm(sqrt(ref.group[[1]]$var)~ref.group[[1]][,paste0("p",climvar)]), lwd=2, col="grey")
legend("topleft",legend=c("w/in Tree", "w/in Plot"), pch=c(1,16), col=c("grey","black"), lty=1, bty="n")
mtext(3,adj=0, text="a)    E. ovata", line=.4)
...
mtext(3,adj=0, text="b)", line=.4)

quartz.save(file=paste0("./",results_dirname,"/Fig6_VarPatterns_test8.pdf"),type = "pdf" )
